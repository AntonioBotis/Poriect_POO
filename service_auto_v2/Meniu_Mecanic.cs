    ...
    public void meniune_mecanic()
        {
            ...
            switch (optiune_mecanic)
            {
                case 0:
                    ...
                    break;
                case 1:
                    cerere.preluare_cerere(Logare.lista_cerere);
                    break;
                case 2:
                    cerere.investigare_cerere(Logare.lista_cerere);
                    break;
                case 3:
                    piesa.creare_cerere_piese(Logare.lista_piesa, Logare.temp_cerere);
                    break;
                case 4:
                    cerere.rezolva_cerere(Logare.lista_cerere);
